...
Feature docs: [agent-chat.md](agent-chat.md) (chat), [file.md](file.md) (file ops), [git.md](git.md) (git ops), [git-ui.md](git-ui.md) (the git panel's UI), [sidebar-ui.md](sidebar-ui.md) (the rules the Files and Git panels share).
