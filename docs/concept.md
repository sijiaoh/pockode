...
Feature docs: [agent-chat.md](agent-chat.md) (chat), [pending-question-entry.md](pending-question-entry.md) (reaching an unanswered question in chat), [file.md](file.md) (file ops), [git.md](git.md) (git ops), [git-ui.md](git-ui.md) (the git panel's UI).
