...
| [Project UI](../project-ui.md) | The project page's information architecture: the two segments, the three groups, which work gets a row, the row itself, and where creating work lands |
