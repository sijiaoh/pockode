...
| `AppShell.tsx:521/528`, `ui/ReconnectBanner.tsx:39` | ~**20px** | Retry and dismiss in the session-error banner, Retry now in the reconnect banner |
| `Worktree/WorktreeCreateSheet.tsx:155` | ~**20px** | the link out of the setup-script note |
| `Chat/ChatPanel.tsx:74` | **24px** | the linked-work pill, in the toolbar row above the input |
