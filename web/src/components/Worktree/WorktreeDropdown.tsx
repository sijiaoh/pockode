		...
		>
			...
			<div className="border-t border-th-border py-2">
				<button
					type="button"
					onClick={onCreateNew}
					className="flex w-full items-center gap-3 px-3 py-2.5 text-th-text-primary transition-colors hover:bg-th-bg-tertiary focus-visible:bg-th-bg-tertiary focus-visible:outline-none"
				>
